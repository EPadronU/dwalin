...
/**
 * Tests validating the functionality of the Page interface as well as the GuardedComponent abstract class.
 */
@Tag("core")
...
public final class GuardedComponentTests extends DwalinWebDriverTest {
  ...
  @Test
  @Tag("sad-path")
  void shouldFailToCreateAGuardedComponentWithANullPage() {
    assertThatCode(() -> {
      open(PAGE_URL);
  ...
  @Test
  @Tag("sad-path")
  void shouldFailToCreateAGuardedComponentWithANullRootElement() {
    assertThatCode(() -> {
  ...
  @Test
  @Tag("sad-path")
  void shouldFailWhenUsingNullInTheAsComponentAndAsComponentsMethodsForGuardedComponents() {
